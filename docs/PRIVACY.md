...
| When you write, or choose Download Only for, a disc that is not in your library | The disk image, from the location the catalogue gives | The provider: `archive.org`, `atarilegend.com`, `d-bug.me`, `exxosforum.co.uk`, `ftp.scene.org` (the scene.org archive and its mirror of the amigascne archive) or `fujiology.org` | Online Downloads, or the provider's own switch, in Preferences, General |
